      ...
      {toggleAboutUs && (
        <div className="pop-details-about-slatt p-3">
          ...
          <small>
            ...
            people. It’s purpose is to empower Nigerians and youths all over the
            universe to connect to the art scene, entertainment, and networking
            around the universe with Nigerian-inspired music, American- inspired
            hip-hop/Rap Music, European-inspired Music, Fashion, Street+Style,
            Instinct, and Culture. The goal is to showcase the Nigerian talents,
            Art Scene, Street+Style Fashion, and Culture (Black Lives) and
            Empower Scale Businesses through the Community's Website, while
            still protecting their safety and privacy. We are also committed to
            protecting human rights and following the principles set up in the
            United Nations Guiding Principles on Human Rights and Small Scale
            Businesses We want slattlife.com to be an authentic and safe place
            for inspiration and expression. We want everyone to have a positive
            experience, and a positive vibe on slattlife.com, so we’ve embedded
            an extensive range of safety tools built to keep our community
            ...
            automatically erased after 24 hours of signing up which has verified
            100% of our users to be well disciplined; first-of-its kind selfie
            verification, a team of Safety Specialists who work 24/7 to
            proactively monitor activity on our platform and respond to reports
            in real-time, customizable tools that allow users to protect
            themselves, reporting features, and educational content.
            ...
            friends/network from anywhere in the universe. Our standard features
            are the following: FORUM: a feature to announce and receive
            information about an ongoing content/event; we provide a suggestions
            box for users to express themself, and interact with one another
            announcement/suggestions randomly. LIVE CHAT AND CHILL: a feature to
            meet and discuss with new people around the universe (slattlife.com
            is not a dating website), Share instincts and ideas,
            Nigerian/American/European inspired music suggestions, Inspired
            Teens/Adult Movie suggestions, Educational talks, Networking and
            play games provided by the Admin; first-of-its-kind. There's another
            way to obtain/access additional specialty features or content on
            Slattlife.com: Having access to connect directly to People you may
            know from the VIP Community Members, People, and Artists on
            Slattlife.com (see more about their daily life+styles from time to
            time here), you can purchase the VIP'S Board-In Checking Card via
            SHOP section. SHOP: Empower Brother/Sisterhood small-scale
            businesses across the universe; This is one of the best ways we can
            support and encourage one another (Please purchase something) Our
            Lifes are in our hands.
          </small>{" "}
          <br />
          <div className="mt-3">
            ...
            <small>
              ...
              anywhere in the universe. Our standard features are the following:
            </small>
            <div className="mt-2">
              <div>
              ...
              <small className="text-white">
                ...
                content/event; we provide a suggestions box for users to express
            ...
            <div className="mt-2">
              ...
              <small className="text-white">
                ...
                suggestions, Inspired Teens/Adult Movie suggestions, Educational
                talks, Networking and play games provided by the Admin;
                first-of-its-kind. There's another way to obtain/access
                additional specialty features or content on Slattlife.com:
                Having access to connect directly to People you may know from
                the VIP Community Members, People, and Artists on Slattlife.com
                (see more about their daily life+styles from time to time here),
                you can purchase the VIP'S Board-In Checking Card via SHOP
                section.
              </small>
            </div>
            <div className="mt-2">
              ...
              <small className="text-white">
                ...
                encourage one another (Please purchase something) Our Lifes are
                in our hands.
              </small>{" "}
              <br />
              <button
